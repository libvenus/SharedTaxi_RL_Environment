...
function Execute() {
  ...
  function handleJoin(meeting) {
    const url = meeting.meeting_url || meeting.body;
                  ...
                  <div className="ex-meeting-layout">
                    ...
                    <div className="ex-meeting-actions">
                      ...
                      <button
                        ...
                        title={
                          meeting.bot_status === "lobby_waiting"
                            ? "Bot is in Teams lobby — open the Teams meeting and click Admit"
                            : meeting.bot_status === "joined"
                            ? "Bot is recording"
                            : "Join meeting and dispatch recording bot"
                        }
                        style={{
                          borderColor:
                            meeting.bot_status === "lobby_waiting" ? "#F59E0B"
                            : meeting.bot_status === "joined" ? "#16A34A"
                            : undefined,
                          color:
                            meeting.bot_status === "lobby_waiting" ? "#B45309"
                            : meeting.bot_status === "joined" ? "#16A34A"
                            : undefined,
                        }}
                      >
                      ...
                      {meeting.bot_status === "lobby_waiting" && (
                        <div style={{ fontSize: 10, color: "#B45309", marginTop: 2, lineHeight: 1.3, maxWidth: 120 }}>
                          Admit &ldquo;Lenovo Sales Assistant&rdquo; in Teams
                        </div>
                      )}
                    </div>
                  </div>
