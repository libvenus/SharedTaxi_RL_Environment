...
MEETING_SEARCH_URL = "http://10.245.240.33/ai-api/meeting-details/meetings/search"
MEETING_DETAILS_URL = "http://10.245.240.33/ai-api/meeting-details/"
...
def create_teams_meeting_invite(
    ...
    try:
        ...
        _LOGGER.info(
            "graph.schedule.start url=%s recipient=%s meeting_start=%s meeting_end=%s",
            events_url,
            recipient_email,
            meeting_start,
            meeting_end,
