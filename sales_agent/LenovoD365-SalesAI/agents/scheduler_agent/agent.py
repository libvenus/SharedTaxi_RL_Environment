...
_CONTACTS_SEARCH_URL = "http://10.245.240.33/api/contacts/search"
...
6. Once you have attendee + date/time, call `create_teams_meeting_invite(recipient_email=..., meeting_start=..., meeting_end=..., meeting_subject=...)`.
